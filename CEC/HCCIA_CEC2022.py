...
def RunHCCIA(func):
    ...
    np.savetxt("./HCCIA_Data/CEC2022/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best,
               delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./HCCIA_Data/CEC2022') == False:
        os.makedirs('./HCCIA_Data/CEC2022')
    Dims = [10, 20]
    for Dim in Dims:
        main(Dim)
